...
func NewOncallScheduleCmd(cfg *config.Config) *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			if cfg.Oncall.DefaultScheduleDuration != "" {
				var err error
				duration, err = time.ParseDuration(cfg.Oncall.DefaultScheduleDuration)
				if err != nil {
